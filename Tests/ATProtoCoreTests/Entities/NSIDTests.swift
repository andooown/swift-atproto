...
final class NSIDTests: XCTestCase {
    ...
    func testEnsureValid() throws {
        // https://github.com/bluesky-social/atproto/blob/44ea5e80fa6f8a8724ff29a06f7fa8fc5d7f57ef/packages/syntax/tests/nsid.test.ts#L40-L158

        try XCTContext.runActivity(named: "enforces spec details") { _ in
        ...
        try XCTContext.runActivity(named: "allows onion (Tor) NSIDs") { _ in
        ...
        try XCTContext.runActivity(named: "allows starting-with-numeric segments (same as domains)") { _ in
        ...
        try XCTContext.runActivity(named: "conforms to interop valid NSIDs") { _ in
        ...
        try XCTContext.runActivity(named: "conforms to interop invalid NSIDs") { _ in
